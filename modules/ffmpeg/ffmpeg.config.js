...
export const {
    test = false, withMetrics = false, parse = false, n = 33,
    ...
    */
    ...
    vf: setVf = true, vf_in = false, vf_range = true, scale_range = vf_range, scale_space = vf_range, chroma_loc = vf_range, vf_space = false, format_space = vf_space,
