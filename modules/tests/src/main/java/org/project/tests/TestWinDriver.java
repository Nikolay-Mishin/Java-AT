...
import static org.project.tests.windriver.Actions.click;
import static org.project.tests.windriver.Actions.clickEl;
import static org.project.tests.windriver.Actions.perform;
import static org.project.tests.windriver.RemoteWebDriver.attachApp;
import static org.project.tests.windriver.RemoteWebDriver.attachAppClass;
import static org.project.tests.windriver.RemoteWebDriver.drivers;
import static org.project.tests.windriver.RemoteWebDriver.startAttach;
import static org.project.tests.windriver.RemoteWebDriver.startAttachClass;
import static org.project.tests.windriver.WebDriver.ls;
import static org.project.tests.windriver.WebElement.findByClass;
import static org.project.tests.windriver.WebElement.findByName;
import static org.project.tests.windriver.WinDriver.findByAId;
...
import org.project.tests.windriver.WinDriver;
import org.project.utils.config.DriverBaseConfig;
import org.project.utils.config.TestBaseConfig;
import org.project.utils.config.WebBaseConfig;
import org.project.tests.windriver.RemoteWebDriver;
...
public class TestWinDriver<T extends TestBaseConfig, W extends WebBaseConfig, D extends DriverBaseConfig> extends TestAuth<T, W, D> {
    ...
    public static ChromeDriver webDriver() throws Exception {
        return org.project.tests.windriver.WebDriver.start();
    }
    ...
    public static ChromeDriver webDriver(String url) throws Exception {
        return org.project.tests.windriver.WebDriver.start(url);
    }
    ...
    public static void quitWeb() {
        org.project.tests.windriver.WebDriver.quit();
        web = null;
    }
    ...
    public static void testDriverInit() {
        ...
        Class<org.project.tests.windriver.WebDriver> webDriver = org.project.tests.windriver.WebDriver.class;
